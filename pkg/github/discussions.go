...
// discussionNode represents a discussion node from the GraphQL API
...
// discussionNodeToIssue converts a discussionNode to a GitHub Issue object
...
// fetchDiscussionNodes fetches discussion nodes from the GraphQL API
// If categoryID is provided, it filters by category; otherwise, it fetches all discussions
