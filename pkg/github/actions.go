...
func ListWorkflowRunArtifacts(getClient GetClientFn, t translations.TranslationHelperFunc) (tool mcp.Tool, handler server.ToolHandlerFunc) {
	return mcp.NewTool("list_workflow_run_artifacts",
		...
		handleListWorkflowRunArtifacts(getClient)
}

// handleListWorkflowRunArtifacts returns the handler for listing workflow run artifacts
func handleListWorkflowRunArtifacts(getClient GetClientFn) server.ToolHandlerFunc {
