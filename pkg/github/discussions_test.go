...
const discussionURL1 = "https://github.com/owner/repo/discussions/1"

var (
	discussionsGeneral = []map[string]any{
		{"number": 1, "title": "Discussion 1 title", "createdAt": "2023-01-01T00:00:00Z", "url": discussionURL1, "category": map[string]any{"name": "General"}},
...
func Test_GetDiscussion(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectError: false,
			expected: &github.Issue{
				HTMLURL:   github.Ptr(discussionURL1),
				Number:    github.Ptr(1),
